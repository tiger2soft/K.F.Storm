...
Section "MainSection" SEC01
  ...
  File "Hardcodet.Wpf.TaskbarNotification.dll"
  File "WPFSoundVisualizationLib.dll"
  File "DoubanFM.exe"
...
Section Uninstall
  ...
  RMDir	"$APPDATA\K.F.Storm\豆瓣电台"
  RMDir "$APPDATA\K.F.Storm"
DeleteExe:
  ...
  Delete "$SMPROGRAMS\豆瓣电台\卸载豆瓣电台.lnk"
  Delete "$SMPROGRAMS\豆瓣电台\豆瓣电台.lnk"
  RMDir "$SMPROGRAMS\豆瓣电台"
